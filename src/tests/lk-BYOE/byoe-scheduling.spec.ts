...
import { ComplianceTrainingPage } from '../../page-objects/shared-pages/ComplainceTraningPage'
import { CalendarPage } from '../../page-objects/shared-pages/CalendarPage'
...
test.describe.parallel('Scheduling', () => {
  ...
  test('Check expert status after scheduling (Scheduled)', async ({
    ...
    await expertsPage.assertPresenceByText('Call scheduled', 'present')
  })
