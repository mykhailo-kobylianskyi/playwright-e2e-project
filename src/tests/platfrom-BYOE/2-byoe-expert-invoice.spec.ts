...
test.describe('Experts Invoice testing', () => {
  ...
  test.beforeAll(async () => {
    ...
    await loginPage.loginWithIAM(user_email, user_password)
    ...
    callDuration = getRandomNumber(16, 100)
  ...
  test.beforeEach(async ({ page }) => {
    ...
    await loginPage.navigate()
    await loginPage.loginWithIAM(admin_finance_email, admin_finance_password)
  ...
  test('Check that Invoice created when the call was completed with correct all required info', async ({}) => {
    ...
    await invoicesPage.assertInvoiceCostAndCurrency(byoeData, callDuration)
